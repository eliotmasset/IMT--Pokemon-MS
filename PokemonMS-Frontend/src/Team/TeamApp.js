        ...
        let list = this.state.pokemon_list.map((pokemon, key)=> {
            ...
            return (
                <li className={className} key={key}>
                    ...
                    {
                        pokemon === undefined || pokemon === null ? <PokemonItem name="Empty" engName="Empty" onClick={()=> this.selectPokemon(key)}/> : <PokemonItem name={pokemon.name} gender={pokemon.gender} level={pokemon.level} engName={pokemon.english_name} onClick={()=> this.selectPokemon(key)}/>
                    }
                </li>
            );
        });
