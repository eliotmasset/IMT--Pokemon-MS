...
UPDATE Pokemon_type SET english_name = 'Turtwig' WHERE id = 1;
UPDATE Pokemon_type SET english_name = 'Grotle' WHERE id = 2;
UPDATE Pokemon_type SET english_name = 'Torterra' WHERE id = 3;
UPDATE Pokemon_type SET english_name = 'Chimchar' WHERE id = 4;
UPDATE Pokemon_type SET english_name = 'Monferno' WHERE id = 5;
UPDATE Pokemon_type SET english_name = 'Infernape' WHERE id = 6;
UPDATE Pokemon_type SET english_name = 'Piplup' WHERE id = 7;
UPDATE Pokemon_type SET english_name = 'Prinplup' WHERE id = 8;
UPDATE Pokemon_type SET english_name = 'Empoleon' WHERE id = 9;
UPDATE Pokemon_type SET english_name = 'Starly' WHERE id = 10;
UPDATE Pokemon_type SET english_name = 'Staravia' WHERE id = 11;
UPDATE Pokemon_type SET english_name = 'Staraptor' WHERE id = 12;
UPDATE Pokemon_type SET english_name = 'Bidoof' WHERE id = 13;
UPDATE Pokemon_type SET english_name = 'Bibarel' WHERE id = 14;
UPDATE Pokemon_type SET english_name = 'Kricketot' WHERE id = 15;
UPDATE Pokemon_type SET english_name = 'Kricketune' WHERE id = 16;
UPDATE Pokemon_type SET english_name = 'Shinx' WHERE id = 17;
UPDATE Pokemon_type SET english_name = 'Luxio' WHERE id = 18;
UPDATE Pokemon_type SET english_name = 'Luxray' WHERE id = 19;
UPDATE Pokemon_type SET english_name = 'Budew' WHERE id = 20;
UPDATE Pokemon_type SET english_name = 'Roserade' WHERE id = 21;
UPDATE Pokemon_type SET english_name = 'Cranidos' WHERE id = 22;
UPDATE Pokemon_type SET english_name = 'Rampardos' WHERE id = 23;
UPDATE Pokemon_type SET english_name = 'Shieldon' WHERE id = 24;
UPDATE Pokemon_type SET english_name = 'Bastiodon' WHERE id = 25;
UPDATE Pokemon_type SET english_name = 'Burmy' WHERE id = 26;
UPDATE Pokemon_type SET english_name = 'Wormadam' WHERE id = 27;
UPDATE Pokemon_type SET english_name = 'Mothim' WHERE id = 28;
UPDATE Pokemon_type SET english_name = 'Combee' WHERE id = 29;
UPDATE Pokemon_type SET english_name = 'Vespiquen' WHERE id = 30;
UPDATE Pokemon_type SET english_name = 'Pachirisu' WHERE id = 31;
UPDATE Pokemon_type SET english_name = 'Buizel' WHERE id = 32;
UPDATE Pokemon_type SET english_name = 'Floatzel' WHERE id = 33;
UPDATE Pokemon_type SET english_name = 'Cherubi' WHERE id = 34;
UPDATE Pokemon_type SET english_name = 'Cherrim' WHERE id = 35;
UPDATE Pokemon_type SET english_name = 'Shellos' WHERE id = 36;
UPDATE Pokemon_type SET english_name = 'Gastrodon' WHERE id = 37;
UPDATE Pokemon_type SET english_name = 'Ambipom' WHERE id = 38;
UPDATE Pokemon_type SET english_name = 'Drifloon' WHERE id = 39;
UPDATE Pokemon_type SET english_name = 'Drifblim' WHERE id = 40;
UPDATE Pokemon_type SET english_name = 'Buneary' WHERE id = 41;
UPDATE Pokemon_type SET english_name = 'Lopunny' WHERE id = 42;
UPDATE Pokemon_type SET english_name = 'Mismagius' WHERE id = 43;
UPDATE Pokemon_type SET english_name = 'Honchkrow' WHERE id = 44;
UPDATE Pokemon_type SET english_name = 'Glameow' WHERE id = 45;
UPDATE Pokemon_type SET english_name = 'Purugly' WHERE id = 46;
UPDATE Pokemon_type SET english_name = 'Chingling' WHERE id = 47;
UPDATE Pokemon_type SET english_name = 'Stunky' WHERE id = 48;
UPDATE Pokemon_type SET english_name = 'Skuntank' WHERE id = 49;
UPDATE Pokemon_type SET english_name = 'Bronzor' WHERE id = 50;
UPDATE Pokemon_type SET english_name = 'Bronzong' WHERE id = 51;
UPDATE Pokemon_type SET english_name = 'Bonsly' WHERE id = 52;
UPDATE Pokemon_type SET english_name = 'Mime Jr.' WHERE id = 53;
UPDATE Pokemon_type SET english_name = 'Happiny' WHERE id = 54;
UPDATE Pokemon_type SET english_name = 'Chatot' WHERE id = 55;
UPDATE Pokemon_type SET english_name = 'Spiritomb' WHERE id = 56;
UPDATE Pokemon_type SET english_name = 'Gible' WHERE id = 57;
UPDATE Pokemon_type SET english_name = 'Gabite' WHERE id = 58;
UPDATE Pokemon_type SET english_name = 'Garchomp' WHERE id = 59;
UPDATE Pokemon_type SET english_name = 'Munchlax' WHERE id = 60;
UPDATE Pokemon_type SET english_name = 'Riolu' WHERE id = 61;
UPDATE Pokemon_type SET english_name = 'Lucario' WHERE id = 62;
UPDATE Pokemon_type SET english_name = 'Hippopotas' WHERE id = 63;
UPDATE Pokemon_type SET english_name = 'Hippowdon' WHERE id = 64;
UPDATE Pokemon_type SET english_name = 'Skorupi' WHERE id = 65;
UPDATE Pokemon_type SET english_name = 'Drapion' WHERE id = 66;
UPDATE Pokemon_type SET english_name = 'Croagunk' WHERE id = 67;
UPDATE Pokemon_type SET english_name = 'Toxicroak' WHERE id = 68;
UPDATE Pokemon_type SET english_name = 'Carnivine' WHERE id = 69;
UPDATE Pokemon_type SET english_name = 'Finneon' WHERE id = 70;
UPDATE Pokemon_type SET english_name = 'Lumineon' WHERE id = 71;
UPDATE Pokemon_type SET english_name = 'Mantyke' WHERE id = 72;
UPDATE Pokemon_type SET english_name = 'Snover' WHERE id = 73;
UPDATE Pokemon_type SET english_name = 'Abomasnow' WHERE id = 74;
UPDATE Pokemon_type SET english_name = 'Weavile' WHERE id = 75;
UPDATE Pokemon_type SET english_name = 'Magnezone' WHERE id = 76;
UPDATE Pokemon_type SET english_name = 'Lickilicky' WHERE id = 77;
UPDATE Pokemon_type SET english_name = 'Rhyperior' WHERE id = 78;
UPDATE Pokemon_type SET english_name = 'Tangrowth' WHERE id = 79;
UPDATE Pokemon_type SET english_name = 'Electivire' WHERE id = 80;
UPDATE Pokemon_type SET english_name = 'Magmortar' WHERE id = 81;
UPDATE Pokemon_type SET english_name = 'Togekiss' WHERE id = 82;
UPDATE Pokemon_type SET english_name = 'Yanmega' WHERE id = 83;
UPDATE Pokemon_type SET english_name = 'Leafeon' WHERE id = 84;
UPDATE Pokemon_type SET english_name = 'Glaceon' WHERE id = 85;
UPDATE Pokemon_type SET english_name = 'Gliscor' WHERE id = 86;
UPDATE Pokemon_type SET english_name = 'Mamoswine' WHERE id = 87;
UPDATE Pokemon_type SET english_name = 'Porygon-Z' WHERE id = 88;
UPDATE Pokemon_type SET english_name = 'Gallade' WHERE id = 89;
UPDATE Pokemon_type SET english_name = 'Probopass' WHERE id = 90;
UPDATE Pokemon_type SET english_name = 'Dusknoir' WHERE id = 91;
UPDATE Pokemon_type SET english_name = 'Froslass' WHERE id = 92;
UPDATE Pokemon_type SET english_name = 'Rotom' WHERE id = 93;
UPDATE Pokemon_type SET english_name = 'Uxie' WHERE id = 94;
UPDATE Pokemon_type SET english_name = 'Mesprit' WHERE id = 95;
UPDATE Pokemon_type SET english_name = 'Azelf' WHERE id = 96;
UPDATE Pokemon_type SET english_name = 'Dialga' WHERE id = 97;
UPDATE Pokemon_type SET english_name = 'Palkia' WHERE id = 98;
UPDATE Pokemon_type SET english_name = 'Heatran' WHERE id = 99;
UPDATE Pokemon_type SET english_name = 'Regigigas' WHERE id = 100;
UPDATE Pokemon_type SET english_name = 'Giratina' WHERE id = 101;
UPDATE Pokemon_type SET english_name = 'Cresselia' WHERE id = 102;
UPDATE Pokemon_type SET english_name = 'Phione' WHERE id = 103;
UPDATE Pokemon_type SET english_name = 'Manaphy' WHERE id = 104;
UPDATE Pokemon_type SET english_name = 'Darkrai' WHERE id = 105;
UPDATE Pokemon_type SET english_name = 'Shaymin' WHERE id = 106;
UPDATE Pokemon_type SET english_name = 'Arceus' WHERE id = 107;